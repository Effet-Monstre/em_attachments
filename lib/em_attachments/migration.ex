defmodule EmAttachments.Migration do
  ...
  `create_em_attachments_uploads_table/1` macro.
      ...
      defmodule MyApp.Repo.Migrations.CreateEmAttachmentsUploads do
        ...
        def change do
          create_em_attachments_uploads_table()
        end
      end

  Pass an atom to use a custom table name:

      create_em_attachments_uploads_table(:my_uploads)
  """

  defmacro create_em_attachments_uploads_table(table_name \\ :em_attachments_uploads) do
    quote do
